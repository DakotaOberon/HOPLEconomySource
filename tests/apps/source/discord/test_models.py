...
class ClientModelTests(TestCase):
    ...
    def test_repr(self):
        self.assertEqual(repr(self.client), "Client(Test Client)")
...
class CategoryModelTests(TestCase):
    ...
    def test_repr(self):
        self.assertEqual(repr(self.category), "Category(Test Category)")
...
class StageChannelModelTests(TestCase):
    def setUp(self):
        self.guild = Guild.objects.create(
            id=123456789012345678,
            name="Test Guild"
        )
        self.channel = StageChannel.objects.create(
            id=123456789012345678,
            name="Test Channel",
            guild=self.guild
        )
    ...
    def test_id_too_short(self):
        with self.assertRaises(ValidationError):
            channel = StageChannel.objects.create(
                id=123456789,
                name="Test Channel 2",
                guild=self.guild
            )
    ...
    def test_repr(self):
        self.assertEqual(repr(self.channel), "StageChannel(Test Channel)")
...
class ForumChannelModelTests(TestCase):
    def setUp(self):
        self.guild = Guild.objects.create(
            id=123456789012345678,
            name="Test Guild"
        )
        self.channel = ForumChannel.objects.create(
            id=123456789012345678,
            name="Test Channel",
            guild=self.guild
        )
    ...
    def test_repr(self):
        self.assertEqual(repr(self.channel), "ForumChannel(Test Channel)")
